...
public class CountList
{
    ...
    public String convert(int number)
    {
        ...
        {
            case 1:
                return decades(number); //вызов функции для 1 числа
            case 2:
                return hundreds(number); //вызов функции для 2-х чисел
            case 3:
    ...
    private String chiliad(int number) // функция возвращает значение числа с 3 цифрами
    {
       ...
       /* else
        {
            String num = chiliad[(number / 100) - 1] + " " + hundreds_2[(number % 110) - 1];
            return num;
        }*/
    }
